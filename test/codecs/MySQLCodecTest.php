...
class MySQLCodecTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->mysqlAnsiCodec = new \PHPESAPI\PHPESAPI\Codecs\MySQLCodec(\PHPESAPI\PHPESAPI\Codecs\MySQLCodec::MYSQL_ANSI);
        $this->mysqlStdCodec = new \PHPESAPI\PHPESAPI\Codecs\MySQLCodec(\PHPESAPI\PHPESAPI\Codecs\MySQLCodec::MYSQL_STD);
    }
