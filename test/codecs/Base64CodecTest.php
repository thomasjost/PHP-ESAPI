...
class Base64CodecTest extends \PHPUnit\Framework\TestCase
{
    private $base64Codec;

    protected function setUp()
    {
        $this->base64Codec = new \PHPESAPI\PHPESAPI\Codecs\Base64Codec();
    }
