...
class CSSCodecTest extends \PHPUnit\Framework\TestCase
{
    private $cssCodec;

    protected function setUp()
    {
        $this->cssCodec = new \PHPESAPI\PHPESAPI\Codecs\CSSCodec();
    }
    ...
    public function testDecodeIgnoreEscapedNewline()
    {
        ...
        // FIXME: consider adding logic to all ESAPI implementations to
        // handle this situation properly (i.e. without throwing malformed
        // entity exception)
    }
     ...
     */
    public function testDecodeEatNullChar()
    {
        $this->assertEquals(
            "CODEPOINT ZERO NOT RECOGNISED IN CSS",
            $this->cssCodec->decode("\\0 CODEP\\0 OINT ZER\\0O NOT\\0  RECOGNISED IN CSS\\0")
        );
        // FIXME: this test yeilds an unexpected error when unpacking
        // in Codec
    }
