...
class RandomAccessReferenceMap implements \PHPESAPI\PHPESAPI\AccessReferenceMap
{
    private $dtoi;
    private $itod;
    private $random = 0;
    ...
    public function getUniqueRandomReference()
    {
        ...
        do {
            $candidate = \PHPESAPI\PHPESAPI\ESAPI::getRandomizer()->getRandomString(6, "123456789");
