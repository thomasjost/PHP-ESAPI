...
class DefaultUser implements \PHPESAPI\PHPESAPI\User
{
    /*
     * The ANONYMOUS user is used to represent an unidentified user. Since
     * there is always a real user, the ANONYMOUS user is better than
